...
==============
changes:
* added examples in the function help and documentation
* added validation vignette (tests many combinations of options within splithalf)
* fixed minor bugs in some combinations of options within splithalf (typically within the )
