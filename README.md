...
1         A 60      0.01  -0.16    0.20          0.01  -0.28    0.33
2         B 60      0.10  -0.07    0.28          0.17  -0.13    0.43
```
...
``` 
  condition  n splithalf 95_low 95_high spearmanbrown SB_low SB_high
1         A 60     -0.15  -0.32    0.04         -0.25  -0.48    0.08
2         B 60     -0.08  -0.25    0.11         -0.14  -0.40    0.20
```
...
``` 
     condition  n splithalf 95_low 95_high spearmanbrown SB_low SB_high
1 change score 60      0.07   -0.1    0.26          0.12  -0.18    0.41
```
